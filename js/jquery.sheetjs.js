...
(function(factory) {
	...
	$.fn.sheetjs = function() {
		...
		$('table.sheetjs', context).each(function() {
			...
			var fullcopyBox = $('<span class="captionmenu" style="margin-left:10px;"><span class="material-icons"></span></span>');
			var rowCountBox = $('<span class="captionbox"><span style="margin-left:3px;"></span></span>');
			var sumBox = $('<span class="captionbox"><span style="margin-left:3px;"></span></span>');
			...
			var ctrlCopy = $('<div class="contextmenu"><span class="material-icons"></span> Copy　<span style="color:#aaa;font-size:95%;">Ctrl+C</span></div>');
			var ctrlSum = $('<div class="contextmenu"><span class="material-icons">functions</span> Sum　<span class="sum"></span></div>');
			var ctrlFilter = $('<div class="contextmenu"><span class="material-icons"></span> Filter　"<span class="flt"></span>"</div>');
			var ctrlNotFilter = $('<div class="contextmenu"><span class="material-icons"></span> Not Filter　"<span class="flt" style="text-decoration:line-through"></span>"</div>');
